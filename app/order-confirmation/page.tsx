...
const RUPEE_TO_EURO = 0.012 // 1 INR = ~0.012 EUR
    ...
    return (
      <div className="min-h-screen bg-background p-4 flex items-center justify-center">
        <Card className="p-8 text-center">
          <p className="text-muted-foreground mb-4">Loading order details...</p>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card className="p-8 mb-6">
          ...
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
            ...
            <p className="text-2xl font-bold text-blue-600 dark:text-blue-300 font-mono">{orderData.orderId}</p>
          </div>

          {/* Table Number */}
          <div className="mb-6 p-4 bg-amber-50 dark:bg-amber-900 rounded-lg">
            <p className="text-sm text-muted-foreground">Table Number</p>
            <p className="text-3xl font-bold text-amber-700 dark:text-amber-300">{orderData.tableNumber}</p>
          </div>
          ...
          <div className="border-t border-border pt-6 mb-6">
            <div className="space-y-2">
              <div className="flex justify-between text-lg font-semibold bg-green-50 dark:bg-green-900 p-3 rounded">
                ...
                <span className="text-green-700 dark:text-green-300">€ {totalInEuros}</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900 rounded-lg mb-6">
            <p className="text-sm text-blue-900 dark:text-blue-100">
              Your order is being prepared in the kitchen. The kitchen staff has been notified.
            </p>
          </div>
        </Card>
